    ...
    <nav class="max-w-7xl mx-auto flex items-center justify-between py-4 px-4 sm:px-6 lg:px-8" aria-label="Main navigation">
        ...
        <div class="flex items-center gap-3">
            ...
            <button @click="$store.theme.toggle()"
                    ...
                    class="hidden md:flex items-center justify-center w-11 h-11 rounded-full text-gray-600 hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-800 transition-colors">
...
<div id="mobile-menu"
     ...
     @keydown.escape="$store.menu.close()"
     class="fixed inset-0 z-50 md:hidden bg-gray-950/95 dark:bg-black/95 backdrop-blur-xl flex flex-col mobile-nav-overlay">
    {{-- Close button --}}
    <div class="flex items-center justify-between px-4 sm:px-6 py-4">
        <span class="font-display font-bold text-lg text-white tracking-wide">Menu</span>
        <button @click="$store.menu.close()"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-6 h-6" aria-hidden="true"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
        </button>
    </div>
    ...
    <nav class="flex-1 flex flex-col justify-center px-8">
        ...
        <div class="mt-12 flex flex-col gap-4">
            ...
            <button @click="$store.theme.toggle()"
                    ...
                    aria-label="Toggle Light and Dark Mode"
                    :aria-pressed="$store.theme.dark ? 'true' : 'false'"
                    class="flex items-center gap-3 min-h-[48px] text-lg text-gray-300 hover:text-sky-400 transition-colors py-3">
                <template x-if="$store.theme.dark">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-5 h-5" aria-hidden="true"><circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/></svg>
                </template>
                <template x-if="!$store.theme.dark">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-5 h-5" aria-hidden="true"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>
                </template>
